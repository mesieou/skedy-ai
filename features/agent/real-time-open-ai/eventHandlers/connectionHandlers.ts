...
/**
 * Properly close WebSocket connection when call ends
 * This ensures a clean closure with code 1000 instead of abnormal 1006
 */
export async function closeWebSocketGracefully(session: Session): Promise<void> {
  try {
