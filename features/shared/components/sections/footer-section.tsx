    ...
    <footer className="relative">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12 mb-12">
          {/* Product Links */}
          <div>
            <h3 className="text-lg font-bold text-card-foreground mb-4 glow-text">Product</h3>
          ...
          {/* Company Links */}
          <div>
            <h3 className="text-lg font-bold text-card-foreground mb-4 glow-text">Company</h3>
            <ul className="space-y-3">
          ...
          {/* Support Links */}
          <div>
            <h3 className="text-lg font-bold text-card-foreground mb-4 glow-text">Support</h3>
            <ul className="space-y-3">
          ...
          {/* Contact Links */}
          <div>
            <h3 className="text-lg font-bold text-card-foreground mb-4 glow-text">Contact</h3>
