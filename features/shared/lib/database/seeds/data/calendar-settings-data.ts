...
// Working hours are stored in BUSINESS LOCAL TIME (Melbourne time)
export const weekdayCalendarSettingsData: CreateCalendarSettingsData = {
  ...
  working_hours: {
    mon: { start: '07:00', end: '17:00' }, // 7 AM - 5 PM Melbourne time
...
export const weekendCalendarSettingsData: CreateCalendarSettingsData = {
    ...
    working_hours: {
      ...
      sat: { start: '07:00', end: '13:00' }, // 7 AM - 1 PM Melbourne time
